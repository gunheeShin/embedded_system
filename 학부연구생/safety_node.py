#------------------------------------------------------
# File name: safety_node
# YOUTIBE LINK: https://youtu.be/MwRyheFMkqw
# Programmed by Gun-Hee Shin on Jan 2022
#-------------------------------------------------------
...
from ackermann_msgs.msg import AckermannDriveStamped    # to publish message which type is geometry_msg/AckermannderiveStamped
...
class Safety(object): #The class that handles emergency braking.
    ...
    def __init__(self):
        ...
        # node subscribes to the scan topic which is of type sensor_msgs/LaserScam. 
    ...
    def scan_callback(self, scan_msg):
        ...
        brake_msg.drive.speed=self.breakspeed            # update parameter 'data' in brake_bool_msg as False
